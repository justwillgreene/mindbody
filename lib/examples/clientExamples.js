...
mbo.client.activeClientsMemberships()
    .then(function (response) {
        console.log(response);
    })
    .catch(function (error) {
...
mbo.client.clientDirectDebitInfo()
    .then(function (response) {
        console.log(response);
    })
    .catch(function (error) {
...
mbo.client.addClientDirectDebitInfo({
    'ClientId': 'string',
...
mbo.client.addClientFormulaNote({
    'ClientId': 'string',
    'AppointmentID': number,
    'Note': 'string'
})
...
// https://api.mindbodyonline.com/public/v6/client/clientrewards 
mbo.client.updateClientRewards({
    'ClientID': 'string',
    'Action': 'string',
    'Points': number,
    'Source': 'string',
...
// https://api.mindbodyonline.com/public/v6/client/clientdirectdebitinfo
mbo.client.deleteDirectDebitInfo({
    'ClientId': 'string'
})
    .then(function (response) {
        console.log(response);
